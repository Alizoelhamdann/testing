...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex overflow-hidden">
      ...
      <main className={`flex-1 min-h-screen transition-all duration-300 ${isSidebarOpen ? 'md:ml-72' : 'ml-0'} w-full max-w-full overflow-x-hidden`}>
        ...
        <div className="mt-8 pb-6 text-center text-xs text-slate-500">
          ...
          <div className="mt-1">Kuli Data Dashboard v1.0</div>
        </div>
      </main>
    </div>
  );
